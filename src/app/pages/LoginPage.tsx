    ...
    <div className="h-[100dvh] w-full bg-background text-foreground font-sans overflow-hidden flex flex-col relative selection:bg-primary/20 transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-8 max-w-md mx-auto w-full space-y-12">
        ...
        >
          ...
          <h1 className="text-4xl font-bold uppercase italic tracking-tighter leading-none">Bienvenido_</h1>
          <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-[0.4em]">Inicia sesión para continuar</p>
        </motion.div>
        ...
        <form onSubmit={handleLogin} className="w-full space-y-4">
          ...
          <div className="flex justify-end px-2">
            <button type="button" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">¿Olvidaste tu contraseña?</button>
          </div>
        ...
        <div className="text-center pt-4">
          <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-widest">
            ¿No tienes cuenta? <Link to="/register" className="text-foreground font-bold hover:underline underline-offset-4">Regístrate_</Link>
          </p>
        </div>
      </main>
    </div>
