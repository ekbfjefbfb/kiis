    ...
    <div className="fixed inset-0 bg-black text-white flex flex-col font-['Plus_Jakarta_Sans'] safe-area-inset overflow-hidden">
      <main className="flex-1 flex flex-col px-10 pt-32">
        <header className="mb-20">
          <div className="w-16 h-16 bg-white rounded-[2rem] flex items-center justify-center mb-10 shadow-2xl">
            <span className="text-black text-2xl font-extrabold tracking-tighter">K</span>
          </div>
          <h1 className="text-5xl font-extrabold tracking-tighter leading-none mb-4 italic text-white">KIIS OS.</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button 
            disabled={loading}
            type="submit"
            className="w-full h-20 bg-white text-black rounded-[2.5rem] font-bold text-xl mt-4 active:scale-[0.97] transition-all duration-300 disabled:opacity-50 flex items-center justify-center shadow-xl group"
          >
            {loading ? (
