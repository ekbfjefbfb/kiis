    ...
    <div className="min-h-screen bg-black text-white flex flex-col font-['Plus_Jakarta_Sans'] overflow-hidden">
      <main className="flex-1 flex flex-col px-10 pt-12 relative">
        ...
        <header className="mb-8">
          <div className="w-12 h-12 bg-white rounded-[1.5rem] flex items-center justify-center mb-6 shadow-[0_20px_40px_rgba(255,255,255,0.1)]">
            <span className="text-black text-xl font-extrabold tracking-tighter">K</span>
          </div>
          <h1 className="text-4xl font-extrabold tracking-tighter leading-none mb-3 italic text-white">Únete.</h1>
          <p className="text-zinc-500 text-base font-medium tracking-tight">Tu identidad académica comienza aquí.</p>
        </header>
          ...
          <div className="space-y-3">
            <div className="group relative">
              <input
                ...
                className="w-full h-14 bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-[2rem] px-6 text-base font-semibold placeholder:text-zinc-800 outline-none focus:border-white/20 focus:bg-zinc-900/60 transition-all duration-500"
                required
              />
            </div>
