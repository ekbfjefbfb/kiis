    ...
    <div className="bg-gray-50 min-h-screen pb-24">
      <div className="bg-white p-6 pt-10 pb-8 rounded-b-3xl shadow-sm border-b border-gray-100 flex flex-col items-center">
        ...
        >
          ...
          <button className="absolute bottom-0 right-0 min-w-[40px] min-h-[40px] w-10 h-10 bg-indigo-600 rounded-full border-2 border-white flex items-center justify-center text-white shadow-md active:bg-indigo-700">
            <Settings size={16} />
          </button>
        </motion.div>
        
        <h2 className="text-xl font-bold text-gray-900">{USER.name}</h2>
        <p className="text-sm text-gray-500">Estudiante de Informática</p>
        ...
        <div className="flex gap-3 mt-6 w-full">
          <div className="flex-1 bg-gray-50 rounded-xl p-3 flex flex-col items-center justify-center gap-1 border border-gray-100">
            <span className="text-xs text-gray-400 font-medium uppercase tracking-wide">Promedio</span>
            <span className="text-lg font-bold text-gray-900">3.8</span>
          </div>
          <div className="flex-1 bg-gray-50 rounded-xl p-3 flex flex-col items-center justify-center gap-1 border border-gray-100">
            <span className="text-xs text-gray-400 font-medium uppercase tracking-wide">Tareas</span>
            <span className="text-lg font-bold text-gray-900">24</span>
          </div>
          <div className="flex-1 bg-gray-50 rounded-xl p-3 flex flex-col items-center justify-center gap-1 border border-gray-100">
            <span className="text-xs text-gray-400 font-medium uppercase tracking-wide">Clases</span>
      ...
      <div className="p-6 space-y-6">
        <section>
          <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 px-2">Información de Contacto</h3>
        ...
        <section>
          <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 px-2">Configuración</h3>
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden divide-y divide-gray-50">
            {[
              ...
              <button key={i} className="w-full min-h-[56px] p-4 flex items-center justify-between hover:bg-gray-50 transition-colors active:bg-gray-100">
            ...
            <Link to="/" className="w-full min-h-[56px] p-4 flex items-center gap-3 hover:bg-red-50 transition-colors text-red-600 active:bg-red-100">
              <LogOut size={18} />
