  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const aiMsg = { 
        id: Date.now() + 1, 
        sender: "ai", 
        text: "I'm a prototype AI. In a real app, I would answer your question about: " + input 
      };
      ...
      <div className="fixed bottom-[70px] w-full max-w-md bg-white border-t border-gray-100 p-4 z-20">
        <form onSubmit={handleSend} className="relative flex items-center gap-2">
          <input
            ...
            className="w-full bg-gray-100 border-0 rounded-full py-3.5 pl-5 pr-12 text-sm text-gray-900 focus:ring-2 focus:ring-indigo-100 focus:bg-white transition-all shadow-inner"
          />
          <button
            type="submit"
            disabled={!input.trim()}
